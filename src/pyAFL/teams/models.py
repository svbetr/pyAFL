...
class Team(object):
    ...
    def __init__(self, name: str, url_identifier: str):
        ...
        self.all_time_players_url = (
            f"https://afltables.com/afl/stats/teams/{url_identifier}.html"
        )
        # URL to all-time-games stats
        self.all_time_games_url = (
            f"https://afltables.com/afl/teams/{url_identifier}/allgames.html"
        )
    ...
    def _get_games(self):
        ...
        for season_html in seasons:
            df = pd.read_html(StringIO(str(season_html)))[0]
