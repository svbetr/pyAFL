...
if __name__ == "__main__":
    ...
    low_tier_gross_win_delta = low_final.loc[2025, "gross_win"].sum()
    low_tier_gross_win_after_lifelines = (
        low.loc[low.season == 2025, "gross_win"].sum() - low_tier_gross_win_delta
    )

    high_tier_gross_win_delta = high_final.loc[2025, "gross_win"].sum()
    high_tier_gross_win_after_lifelines = (
        high.loc[high.season == 2025, "gross_win"].sum() - high_tier_gross_win_delta
    )
    ...
    low_summary["gross_win_losing_bets_post_lifelines"] = (
        low_summary["gross_win_all_lifeline_eligible_bets"] - low_summary["gross_win"]
    )
    ...
    high_summary["gross_win_losing_bets_post_lifelines"] = (
        high_summary["gross_win_all_lifeline_eligible_bets"] - high_summary["gross_win"]
    )
